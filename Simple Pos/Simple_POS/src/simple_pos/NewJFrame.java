  ...
  public void addtable(int id ,String Name, int Qty ,Double Price){
   ...
   double tot = 0.0 ;
    ...
    private void initComponents() {
        ...
        q1.setForeground(new java.awt.Color(215, 0, 0));
        ...
        q2.setForeground(new java.awt.Color(215, 0, 0));
        ...
        q3.setForeground(new java.awt.Color(215, 0, 0));
        q3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        q3.setText("0");

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/10.png"))); // NOI18N
        ...
        q6.setForeground(new java.awt.Color(215, 0, 0));
        ...
        q5.setForeground(new java.awt.Color(215, 0, 0));
        q5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        q5.setText("0");

        q4.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        q4.setForeground(new java.awt.Color(215, 0, 0));
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/6.png"))); // NOI18N
        ...
        q9.setForeground(new java.awt.Color(215, 0, 0));
        q9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        q9.setText("0");

        q8.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        q8.setForeground(new java.awt.Color(215, 0, 0));
        q8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        q8.setText("0");

        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/9.png"))); // NOI18N
        ...
        q7.setForeground(new java.awt.Color(215, 0, 0));
        ...
        jLabel2.setForeground(new java.awt.Color(215, 0, 0));
        jLabel2.setText("Cash :");

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 30)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(215, 0, 0));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        addtables(3, "Cheeseburger", i, 5.00);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        addtables(4, "Double-Double", i, 10.29);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        addtables(5, "French fries", i, 3.19);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        addtables(6, "Fries animal style", i, 5.99);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        addtables(7, "Vanilla shake", i, 3.99);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        addtables(9, "Pink lemonade", i, 2.99);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       // btn code
        ...
        addtables(10, "Chocolate shake", i, 3.99);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
           ...
           b.setText("                         Ghaisanallam.a \n");
            b.setText(b.getText() + "                         589/ Grue road, \n");
            b.setText(b.getText() + "                         Jakarta, Indonesia, \n");
            b.setText(b.getText() + "                         +61 81213146001, \n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Thank you for Your money...!"+"\n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Make sure to rate us 5 Stars... Or else"+"\n");
